...
/**
 * Вызывается после добавления элемента инфоблока.
 */
class OnAfterIBlockElementAddEvent implements Event
{
    use AutodetectedEventMetaTrait;

    public const PARAM_RESULT = 'RESULT';
    public const PARAM_ID = ElementTable::ID;
    ...
    /**
     * Успешна ли операция добавления элемента инфоблока.
     *
